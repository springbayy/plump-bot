...
Stage 1 trains a small (~6M-parameter) schema-v4 PPO baseline quickly; stage 2
warm-starts schema-v5 expert iteration from it:

```bash
zsh scripts/run_training_v6_8m_seed1.zsh      # stage 1: PPO from random weights
zsh scripts/run_training_v7_8m_expert_seed1.zsh  # stage 2: expert iteration from v6 best.pt
```
